...
class AdminRouter {
    ...
    getRoutes() {
        ...
        this.router.get('/transaction/user/:id', GlobalMiddleWare_1.GlobalMiddleWare.adminAuthenticate, AdminValidators_1.AdminValidators.allUserTransaction(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, AdminController_1.AdminController.allUserTransaction);
    ...
    postRoutes() {
        ...
        this.router.post('/deposit', GlobalMiddleWare_1.GlobalMiddleWare.adminAuthenticate, AdminValidators_1.AdminValidators.deposit(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, AdminController_1.AdminController.deposit);
        this.router.post('/order/create', GlobalMiddleWare_1.GlobalMiddleWare.adminAuthenticate, AdminValidators_1.AdminValidators.orderCreate(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, AdminController_1.AdminController.orderCreate);
    }
    patchRoutes() {
