...
class PaperValidators {
    static create() {
        return [
            ...
            (0, express_validator_1.body)('year', 'year Is Required'),
            (0, express_validator_1.body)('paper', 'paper Is Required'),
    ...
    static paperType() {
        return [(0, express_validator_1.param)('paper_type').custom((paper_type, { req }) => {
